...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-8">
      <!--kolonne nr 2 -->
      <h1>Stats for <?php echo $_POST['Format']; ?></h1>
      <br>
      <div class="container">
        <div class="row">
          <div class="col-sm">
            ...
            <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Du har spillet <?php echo $antalturn; ?> turneringer i dette format!</p>
              </div>
            </div>
        <br>
        <div class="card" style="width: 18rem;">
        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Du har tabt <?php echo $losses; ?> runder med dette deck!</p>
          </div>
        </div>
          </div>
          <div class="col-sm">
            ...
            <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Du har vundet <?php echo $wins; ?> runder med dette deck!</p>
              </div>
            </div>
